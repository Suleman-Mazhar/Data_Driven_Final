...
import EditRestrictionsForm from '../components/critical-items/EditRestrictionsForm';
...
const CriticalItems = () => {
  ...
  const handleFindNearby = (item) => {
    // Navigate to the CriticalItemsMap page with the selected item information
    navigate('/find-items', { state: { selectedItemId: item.item_id, selectedItemName: item.name } });
  };
